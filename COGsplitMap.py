...
def main():
    ...
    st.markdown("<h1 style='text-align: center;'>COG SplitMap</h1>", unsafe_allow_html=True)
    ...
    left_image_url = f"https://kaoutar-elmouh.github.io/COG/ATTRIBUTSCOG/{selected_attribut}_{selected_jour1}.tif"
    right_image_url = f"https://kaoutar-elmouh.github.io/COG/ATTRIBUTSCOG/{selected_attribut}_{selected_jour2}.tif"
